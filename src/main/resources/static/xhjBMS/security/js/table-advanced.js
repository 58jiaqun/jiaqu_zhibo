var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            sOut += '<tr><td>合同申请类型：'+aData[2]+'</td></tr>';
            sOut += '<tr><td>申请部门：'+aData[3]+'</td></tr>';
            sOut += '<tr><td>申请人员：'+aData[4]+'</td></tr>';
            sOut += '<tr><td>申请时间：'+aData[5]+'</td></tr>';
            sOut += '<tr><td>状态：'+aData[6]+'</td></tr>';
            sOut += '<tr><td>状态1：'+aData[7]+'</td></tr>';
            sOut += '<tr><td>状态2：'+aData[8]+'</td></tr>';
            sOut += '<tr><td>状态3：'+aData[9]+'</td></tr>';
            sOut += '<tr><td>协议4：'+aData[10]+'</td></tr>';
            sOut += '</table>';
