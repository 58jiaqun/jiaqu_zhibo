...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownBtn = $('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">筛选展示 <span class="caret"></span></button>');
        ...
        if(this.options.addDisplayAllBtn) {
            ...
            this.$displayAllBtn = $('<button class="btn btn-default">全部展示</button>');
